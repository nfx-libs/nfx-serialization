...
if(NOT NFX_SERIALIZATION_PACKAGE_SOURCE
        AND NOT NFX_SERIALIZATION_PACKAGE_ARCHIVE
        AND NOT NFX_SERIALIZATION_PACKAGE_DEB
        AND NOT NFX_SERIALIZATION_PACKAGE_RPM
        AND NOT NFX_SERIALIZATION_PACKAGE_WIX)
    return()
endif()
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "Modern C++20 JSON serialization library with with extensible trait capabilities and automatic type mapping")
...
if(NFX_SERIALIZATION_PACKAGE_SOURCE)
...
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY  "nfx-serialization")
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
    ...
    set(CPACK_RPM_PACKAGE_LICENSE      ${NFX_SERIALIZATION_LICENSE})
